  ...
  return (
    <section className="space-y-8">
      ...
      <div className="card space-y-4">
        <h2 className="text-2xl font-bold text-white">📊 요금제 비교</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-800">
                <th className="text-left py-3 px-4 font-semibold text-slate-100">기능</th>
                <th className="text-center py-3 px-4 font-semibold text-slate-100">스타터</th>
                <th className="text-center py-3 px-4 font-semibold text-primary">프로</th>
                <th className="text-center py-3 px-4 font-semibold text-slate-100">에이전시</th>
              </tr>
            </thead>
            <tbody className="text-slate-300">
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">월 생성 횟수</td>
                <td className="text-center py-3 px-4">3회</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">무제한</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">무제한</td>
              </tr>
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">JSON 스키마 결과</td>
                <td className="text-center py-3 px-4">✓</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">브랜드 보이스 요약</td>
                <td className="text-center py-3 px-4">✓</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">팀 공유 링크</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">CSV 내보내기</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">다중 브랜드 관리</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
              <tr className="border-b border-slate-800">
                <td className="py-3 px-4">전담 성공 매니저</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
              <tr>
                <td className="py-3 px-4">커스텀 프롬프트 컨설팅</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4">-</td>
                <td className="text-center py-3 px-4 font-semibold text-primary">✓</td>
              </tr>
      ...
      {/* 자주 묻는 질문 */}
      <div className="card space-y-4">
        <h2 className="text-2xl font-bold text-white">❓ 요금제 관련 자주 묻는 질문</h2>
        <div className="space-y-4">
          <div className="space-y-2">
            <h3 className="font-semibold text-slate-100">Q1. 무료 플랜으로도 충분한가요?</h3>
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-slate-100">Q2. 프로 요금제와 에이전시 플랜의 차이는 무엇인가요?</h3>
            <p className="text-sm text-slate-300">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-slate-100">Q3. 요금제를 나중에 변경할 수 있나요?</h3>
            <p className="text-sm text-slate-300">
          ...
          <div className="space-y-2">
            <h3 className="font-semibold text-slate-100">Q4. 연간 결제 할인이 있나요?</h3>
            <p className="text-sm text-slate-300">
