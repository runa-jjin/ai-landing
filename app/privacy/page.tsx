  ...
  return (
    <section className="space-y-4 pt-24 max-w-6xl mx-auto px-4">
      ...
      <div className="card space-y-3 p-3 text-xs text-slate-300 leading-relaxed">
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">1. 개인정보처리방침의 의의</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">2. 수집하는 개인정보의 항목 및 수집 방법</h2>
          <div className="space-y-2">
            <h3 className="text-xs font-semibold text-slate-100">2.1 수집 항목</h3>
            ...
            <h3 className="text-xs font-semibold text-slate-100 mt-2">2.2 수집 방법</h3>
            <ul className="list-disc list-inside space-y-1 ml-4">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">3. 개인정보의 처리 목적</h2>
          <ul className="list-disc list-inside space-y-1 ml-4">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">4. 개인정보의 보유 및 이용 기간</h2>
          <ul className="list-disc list-inside space-y-1 ml-4">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">5. 쿠키의 운영 및 거부</h2>
          <div className="space-y-2">
            <p>
              본 서비스는 이용자에게 개인화된 서비스를 제공하기 위해 쿠키를 사용합니다.
            </p>
            <h3 className="text-xs font-semibold text-slate-100">5.1 쿠키의 사용 목적</h3>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>로그인 상태 유지 및 세션 관리</li>
              <li>이용자의 접속 빈도 및 방문 시간 분석</li>
              <li>서비스 이용 패턴 파악 및 맞춤형 서비스 제공</li>
            </ul>
            <h3 className="text-xs font-semibold text-slate-100 mt-2">5.2 쿠키 설정 거부 방법</h3>
            <p>
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">6. 제3자 서비스 및 개인정보 제공</h2>
          <div className="space-y-2">
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">7. 개인정보의 위탁 처리</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">8. 개인정보의 안전성 확보 조치</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">9. 이용자의 권리 및 행사 방법</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">10. 개인정보 보호책임자</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-slate-100 mb-2">11. 개인정보처리방침의 변경</h2>
          <p>
